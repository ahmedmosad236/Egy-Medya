...
//     <motion.section
//       id="contact"
//       className="text-white py-20 px-6 md:px-16 relative overflow-hidden" // py-20 and px-6 for mobile, md:px-16 for larger screens
//       initial={{ opacity: 0, y: 50 }}
//       whileInView={{ opacity: 1, y: 0 }}
//       viewport={{ once: true, amount: 0.3 }}
//       transition={{ duration: 0.8 }}
...
//                       name="firstName"
//                       placeholder="First Name"
//                       className="w-full bg-[#1c1b18] text-white placeholder-[#9D9FA1] py-3 px-4 md:py-4 md:px-7 rounded-md focus:outline-none focus:ring-2 focus:ring-[#D4AF37] border border-gray-700" // Padding adjusted for mobile
//                       required
//                     />
//                   </div>
//                   <div className="flex-1">
...
//                     id="email"
//                     name="email"
//                     placeholder="Email address" // Changed placeholder to match screenshot
//                     className="w-full bg-[#1c1b18] text-white placeholder-[#9D9FA1] py-3 px-4 md:p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#D4AF37] border border-gray-700" // Padding adjusted for mobile
//                     required
//                   />
//                 </div>
//                 <div>
...
//                     id="message"
//                     name="message"
//                     placeholder="How we can help?" // Changed placeholder to match screenshot
//                     className="w-full h-24 md:h-32 bg-[#1c1b18] text-white placeholder-[#9D9FA1] py-3 px-4 md:p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#D4AF37] border border-gray-700 resize-none" // Height and padding adjusted for mobile
//                     required
//                   ></textarea>
//                 </div>
//                 <button
//                   type="submit"
//                   className="bg-[#D4AF37] text-black font-semibold py-3 px-10 rounded-full hover:bg-yellow-500 transition duration-300 text-lg disabled:opacity-50 disabled:cursor-not-allowed w-full md:w-auto" // Button width adjusted for mobile
//                   disabled={loading}
//                 >
//                   {loading ? "Sending..." : "Send message"}{" "}
//                   {/* Text case adjusted for screenshot */}
//                 </button>
//                 {success && (
...
//           {" "}
//           {/* Margin top and padding adjusted for mobile, text centered for mobile */}
//           <div className="flex flex-col lg:flex-row items-center justify-center md:justify-between mb-8 md:mb-12 ">
//             {" "}
//             {/* Centered items for mobile, gap adjusted */}
//             {/* Logo and Tagline */}
...
//                 {" "}
//                 {/* Added horizontal padding for mobile tagline wrapping */}
//                 <p className="text-gray-400 text-base font-normal pr-72 mb-20">
//                   We Drive Real Result, More Traffic, More Leads, more Growth!
//                 </p>
//               </div>
//               <div className="flex items-center gap-4">
//                 <a
//                   href="https://wa.me/+1 (952) 607-0861"
//                   target="+1 (952) 607-0861"
//                   rel="noopener noreferrer"
//                   className="text-gray-400 hover:text-green-500 transition-colors"
//                   aria-label="WhatsApp"
//                 >
...
//             </div>
//             {/* Navigation Links */}
//             <nav className="flex flex-col items-center gap-4 text-sm md:flex-row md:gap-8">
//               {" "}
//               {/* Changed to flex-col and centered for mobile, gap adjusted */}
//               <a
//                 href="#"
//                 className="text-gray-400 hover:text-[#D4AF37] transition-colors"
//               >
...
//             {" "}
//             {/* Gap for mobile, mt/pt adjusted */}
//             <p>© 2024 Orbit, Inc. All rights reserved</p>
//             <div className="flex items-center gap-2 mt-0">
//               {" "}
//               {/* Removed mt-4 md:mt-0 as it's not needed with flex-col on parent */}
//               <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
//                 <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
//               </svg>
//               <span>MINNESOTA STATE</span>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="">
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-[#D4AF37] text-black font-semibold py-3 px-10 rounded-full hover:bg-yellow-500 transition duration-300 text-lg disabled:opacity-50 disabled:cursor-not-allowed w-full md:w-auto"
                  disabled={loading}
                >
                  {loading ? "Sending..." : "Send message"}
                </button>
        ...
        <footer className="mt-16 md:mt-20 pt-8 md:pt-12 pb-8 border-t border-gray-800 text-center md:text-left">
          <div className="flex flex-col lg:flex-row items-center justify-center md:justify-between mb-8 md:mb-12 gap-8">
            ...
            {/* Navigation Links */}
            {/* التعديل: هنا جعلنا الـ flex أفقيًا بشكل دائم مع التفاف العناصر */}
